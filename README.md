...
**Version 1.7.3 — feature complete.** The castle-styled title page now stages an
...
`com.configmancooper.aetherglyph`, API 24 → 36, versionCode 10703 /
versionName 1.7.3). Both the native package and installable web app offer
...
- **Capacitor Android project (checked in).** `com.configmancooper.aetherglyph`,
  ...
  `versionCode 10703` / `versionName 1.7.3`, no cleartext production traffic,
