...
**Version 1.13.0 — feature complete.** The castle-styled title page now stages an
...
available for ready-up rematches. Version 1.13.0 adds persistent Glyph world
...
`com.configmancooper.aetherglyph`, API 24 → 36, versionCode 11300 /
versionName 1.13.0). Both the native package and installable web app offer
...
- **Capacitor Android project (checked in).** `com.configmancooper.aetherglyph`,
  ...
  `versionCode 11300` / `versionName 1.13.0`, HTTPS production traffic plus
