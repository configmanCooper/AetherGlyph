...
**Version 1.7.11 — feature complete.** The castle-styled title page now stages an
...
`com.configmancooper.aetherglyph`, API 24 → 36, versionCode 10711 /
versionName 1.7.11). Both the native package and installable web app offer
...
- **Capacitor Android project (checked in).** `com.configmancooper.aetherglyph`,
  ...
  `versionCode 10711` / `versionName 1.7.11`, no cleartext production traffic,
