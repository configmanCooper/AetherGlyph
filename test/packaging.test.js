...
ok(appGradle.includes('versionCode 11302'), 'gradle versionCode 11302');
...
ok(publishingGuide.includes('| Version code | `11302` |'), 'publishing guide versionCode 11302');
...
ok(read('client/index.html').includes('id="menu-version"')
    && !read('client/index.html').includes('href="/MASTERPLAN.md"'),
  'main menu shows the version and no Master Plan link');
...
ok(main.includes('serviceWorkerReloadPending') && main.includes('online?.inMatch'),
  'service-worker upgrades defer reloads until authoritative online matches end');
