...
const DETAILS = {
  ...
  3: ['6 direct damage.', 'Static for 9 sec (max 3). One stack interrupts the next channel; 3 stacks prime Storm stuns.', 'Fast poke, channel disruption, and Thunderclap/Chain Lightning setup.'],
  ...
  7: ['18 direct damage; Soaked targets take 25% bonus Storm damage.', 'Soaked or Static-3 targets are stunned for 0.8 sec. While any Wet zone exists, Conductive Arc leaves the target Soaked after the hit for later lightning.', 'Storm payoff after Rain or repeated Spark Darts.'],
  ...
  11: ['60-point all-direction barrier for 9 sec.', 'Protects from every direction, but its caster cannot start offensive spells.', 'Survive heavy bursts, area spells, and uncertain attack angles.'],
  ...
  14: ['No direct damage; short 0.5-arc relocation.', 'Invisible for 3 sec with a 1.05 sec evade window; removes Root.', 'Escape Root, disappear from view, and evade heavy tells or targeted projectiles.'],
  15: ['26-HP cover for up to 24 sec.', 'Reduces incoming non-piercing projectile damage by 50%; Quake and Fireball destroy it.', 'Create safe Focus windows, block line pressure, and control sightlines.'],
  16: ['No damage.', 'Haste for 18 sec: +15% movement speed and removes Chilled. It does not shorten normal post-cast recovery.', 'Rushdown tempo, mobility, and countering Tide slows.'],
  ...
  23: ['No direct damage.', 'Sloth for 12 sec: 18% movement and recovery slow.', 'Keep targets inside zones and make telegraphed attacks harder to escape.'],
  24: ['Drains up to 18 Aether; caster gains half.', 'Cannot drain the protected final 12 Aether.', 'Resource warfare, interrupting expensive plans, and sustaining attrition.'],
  ...
  26: ['No direct damage.', 'Roots the target for 4.5 sec. Rooted targets cannot move but may cast.', 'Hold targets inside zones and force stationary defensive choices.'],
  27: ['No direct damage.', 'Freezes for 1 sec only if the target is Chilled; consumes Chilled and grants Tenacity afterward.', 'Earned hard-control payoff for Tide combos.'],
  28: ['6 direct damage.', 'Non-reflectable air shockwave with knockback; interrupts casts, channels, and Focus.', 'Fast interruption, spacing control, and denying economy channels.'],
  29: ['No direct damage.', 'Blinded for 6 sec: reduces central clarity while preserving threat outlines and HUD.', 'Create uncertainty, support feints, and improve zone pressure.'],
  30: ['8 direct damage.', 'Stuns 0.8 sec only if the target is Soaked or has 3 Static. It consumes Static stacks but leaves Soaked active.', 'Storm control payoff with a shorter release than heavy lightning.'],
  ...
  32: ['No direct damage; shared Wet zone for 21 sec.', 'Douses Burning and Fire. While it exists, it globally enables Conductive Arc; it also enables lightning bonuses on Soaked targets and Frozen Ground reactions.', 'Control the elemental state of the arena and set up Tide/Storm combos.'],
  ...
  36: ['No direct damage; visible trap lasts up to 24 sec.', 'Roots a non-owner for 1 sec when crossed, then the trap is consumed.', 'Lane control, movement punishment, and setup for area attacks.'],
};
...
const COUNTERS = {
  ...
  29: ['Dispel', 'Barrier while vision is impaired', 'Use HUD and threat outlines'],
