...
const DETAILS = {
  ...
  30: ['8 direct damage.', 'Stuns/paralyzes for 4 sec only if the target is Soaked or has 2 Static. It strips buffs and increases all spell damage taken by 25%; the caster is Knocked Down on release whether paralysis triggers or not.', 'High-risk Storm control payoff with punishable caster backlash.'],
