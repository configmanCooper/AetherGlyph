...
const DETAILS = {
  ...
  30: ['8 direct damage.', 'Stuns for 2 sec only if the target is Soaked or has 3 Static. The target cannot move or cast. It consumes Static stacks but leaves Soaked active.', 'Storm control payoff with a shorter release than heavy lightning.'],
