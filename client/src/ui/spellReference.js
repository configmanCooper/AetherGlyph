...
const DETAILS = {
  ...
  29: ['No direct damage.', 'Blinded for 4 sec: whites out the opponent area while controls, guides, HUD, and spell effects remain usable. Practice AI loses opponent awareness.', 'Create a four-second action window for movement, setup, or pressure.'],
