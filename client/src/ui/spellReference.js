...
const DETAILS = {
  1: ['8 direct; Burning can add 18 damage per stack over 9 sec (max 2 stacks).', 'Reflectable fast projectile. A Burning hit removes Chilled, and Ember ignites Oil.', 'Fast pressure, finishing low-health targets, and setting up Oil reactions.'],
  2: ['10 direct damage.', 'Chilled for 9 sec: 18% movement/recovery slow. A Chilled hit removes Burning and primes Frost Bind/Frozen Ground.', 'Reliable Tide poke and the main setup for freeze combos.'],
  ...
  7: ['18 direct damage; Soaked targets take 25% bonus Storm damage.', 'Soaked or Static-2 targets are stunned for 2 sec. Stun strips buffs and increases all spell damage taken by 25%. Conductive Wet grants maximum Static to both wizards and another 25% Storm bonus.', 'Storm payoff after Rain or two Spark Darts.'],
  8: ['30 area damage plus Burning.', 'Large non-reflectable projectile; blasts a Fireball-sized hole and removes 30 Stone Wall HP, and ignites Oil.', 'Major telegraphed finisher, cover fracture, and Flash Fire combos.'],
  9: ['26 area damage plus Chilled.', 'Large non-reflectable ice comet. Converts Wet ground to Frozen Ground, Chilling both wizards and empowering frost damage by 25%.', 'Heavy Tide finisher, area denial, and freeze setup.'],
  ...
  14: ['No direct damage; short 0.5-arc relocation.', 'Invisible for 3 sec with a 1.05 sec evade window; removes Root. Foes stop tracking your position, and your Ward, Barrier Dome, and Reflect visuals are hidden with you.', 'Escape Root, conceal active protection, break homing, and evade targeted projectiles.'],
  15: ['60-HP cover for up to 24 sec.', 'Intercepts non-piercing projectiles and beams. Fireball removes 30 HP and leaves a visible hole; Quake can shatter a full wall.', 'Create safe Focus windows, fully block direct projectile pressure, and control sightlines.'],
  ...
  19: ['No damage.', 'Ember Attunement for 30 sec: Ember spells cost 50% less Aether.', 'Commit to sustained fire pressure and environmental Ember chains.'],
  ...
  25: ['No direct damage.', 'Veiled for 6 sec: distorts visible trace ink and, each full second, adds 1 sec to every cooldown that is still active.', 'Disrupt execution and delay the target’s spell rotation before a pressure sequence.'],
  ...
  27: ['No direct damage.', 'Freezes a Chilled or Soaked target for 4 sec and consumes that setup. Freeze strips buffs and increases non-Ember spell damage taken by 25%.', 'Powerful earned hard-control payoff for Tide combos.'],
  28: ['6 direct damage.', 'Non-reflectable air shockwave with knockback and interruption. Knocks the target down for 2 sec, preventing movement/Dodge and increasing spell damage taken by 10% unless Grounded.', 'Fast interruption, spacing control, and denying economy channels.'],
  29: ['No direct damage.', 'Blinded for 4 sec: whites out the opponent area while controls, guides, HUD, and spell effects remain usable. The blinded caster receives no homing or position tracking and fires opposite their own arc.', 'Create a four-second action window for movement, setup, or pressure.'],
  30: ['8 direct damage.', 'Stuns/paralyzes for 4 sec only if the target is Soaked or has 2 Static. It strips buffs and increases all spell damage taken by 25%; Static is consumed, Soaked remains, and the caster is Knocked Down on release whether paralysis triggers or not.', 'High-risk Storm control payoff with punishable caster backlash.'],
  31: ['No direct damage; shared Oil zone for 21 sec.', 'Ember causes Flash Fire: its Fire zone grants +25% Ember spell damage to both sides. Rain washes Oil away; Gust moves it.', 'Prepare explosive terrain and force movement or counter-weather decisions.'],
  32: ['No direct damage; shared Rain lasts 21 sec.', 'Both duelists become Wet and become Soaked after 5 sec. Conductive Arc grants both maximum Static and +25% Storm spell damage while Wet remains.', 'Control the elemental state of the arena and set up Tide/Storm combos for either side.'],
  33: ['No direct damage; Gust lasts 6 sec with a 5.5 sec deflect window.', 'Deflects light projectiles, clears Fog, moves Oil, spreads Fire for a shorter duration, and knocks the foe down for 2 sec unless Grounded.', 'Reactive projectile defense, movement denial, and environmental repositioning.'],
  ...
  35: ['No direct damage; shared Fog zone for 18 sec.', 'Visually obscures both sides and disables homing and enemy-position tracking. Both casters face and fire opposite their own arc. Gust and Flame Wave clear it.', 'Hide setup timing, break target tracking, and create symmetric uncertainty.'],
...
const COUNTERS = {
  ...
  15: ['Quake', 'Fireball fractures a hole', 'Stone Shard gains bonus damage against its owner', 'Sunder'],
  ...
  27: ['Dispel Chilled/Soaked before Frost Bind', 'Avoid Tide setup', 'Tenacity blocks repeated hard control'],
  ...
  33: ['Stone Shard and other heavy projectiles', 'Wait out the 5.5-second deflect window', 'Reposition'],
