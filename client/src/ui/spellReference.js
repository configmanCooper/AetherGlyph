...
const DETAILS = {
  ...
  7: ['18 direct damage; Soaked targets take 25% bonus Storm damage.', 'Soaked or Static-2 targets are stunned for 0.8 sec. Stun strips buffs and increases all spell damage taken by 25%. Conductive Wet grants maximum Static to both wizards and another 25% Storm bonus.', 'Storm payoff after Rain or two Spark Darts.'],
  ...
  27: ['No direct damage.', 'Freezes a Chilled or Soaked target for 3 sec and consumes that setup. Freeze strips buffs and increases non-Ember spell damage taken by 25%.', 'Powerful earned hard-control payoff for Tide combos.'],
  ...
  30: ['8 direct damage.', 'Stuns/paralyzes for 2 sec only if the target is Soaked or has 2 Static. It strips buffs and increases all spell damage taken by 25%; Static is consumed but Soaked remains.', 'Storm control payoff with a shorter release than heavy lightning.'],
