...
export const CAMPAIGN = [
...

  {
    ...
    opponentLoadout: PRESETS_BY_KEY['arcane-combo'].ids.slice(),
    taughtSpells: [],
    drills: [],
  ...
  // --- secret trials (optional; cover roster 37-40) -------------------------
  {
    ...
    taughtSpells: [{ id: 37, enterStage: 1, exitStage: 1 }],
    drills: [],
    trialSpell: 37,
    guideFraction: 0.25,
    ...
    objectives: [
      { id: 'cast', text: 'Draw Mirror Twin', predicate: 'cast-spell:37', expectSpell: 37 },
...

  {
    ...
    narration: [
      'The sand catches hostile magic, never its keeper.',
      'Lay the Hourglass Field, then slip an enemy shot slowed to one-quarter speed.',
    ],
    timerEnabled: false, pressureEnabled: false,
    playerLoadout: [38], opponentLoadout: [3],
    taughtSpells: [{ id: 38, enterStage: 1, exitStage: 1 }],
    drills: [],
    trialSpell: 38,
    guideFraction: 0.25,
    arena: { playerCharges: 2 },
    ...
    objectives: [
      { id: 'cast', text: 'Lay the Hourglass Field', predicate: 'cast-spell:38', expectSpell: 38 },
...

  {
    ...
    taughtSpells: [{ id: 39, enterStage: 1, exitStage: 1 }],
    drills: [],
    trialSpell: 39,
    guideFraction: 0.25,
    ...
    objectives: [
      { id: 'covenant', text: 'Activate Phoenix Covenant', predicate: 'self-status:Phoenix', expectSpell: 39 },
...

  {
    ...
    taughtSpells: [{ id: 40, enterStage: 1, exitStage: 1 }],
    drills: [],
    trialSpell: 40,
    guideFraction: 0.25,
