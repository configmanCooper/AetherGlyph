...
This guide is tailored to the current Aetherglyph 1.11.0 Android releases.
...
| --- | --- | --- | --- | --- |
| Full game | Aetherglyph: Arcane Duels | `com.configmancooper.aetherglyph` | **$4.99 paid, one-time purchase** | `dist\Aetherglyph-1.11.0-release.aab` |
| Demo | Aetherglyph: Arcane Duels Demo | `com.configmancooper.aetherglyph.demo` | **Free** | `dist\Aetherglyph-Demo-1.11.0.aab` |
...
| App Bundle | `dist\Aetherglyph-1.11.0-release.aab` |
...
| Target audience | 13–15, 16–17, 18 and over |
| Version code | `11100` |
| Version name | `1.11.0-demo` |
| Minimum Android | Android 7.0 / API 24 |
| Target Android | API 36 |
| App Bundle | `dist\Aetherglyph-Demo-1.11.0.aab` |
...
3. Upload:
   ...
   `dist\Aetherglyph-1.11.0-release.aab`
...
5. Release name: `1.11.0 reaction overhaul`.
6. Suggested release notes:

   ```text
   <en-US>
   Expanded environmental reactions and control tactics. Frozen Ground,
   Conductive Arc, Flash Fire, Spreading Flame, Veil Hex, Gust Wall, and
   Fractured Cover now have stronger strategic effects, with updated tutorials.
   </en-US>
   ```
...
4. Add the already uploaded 1.11.0 bundle from the library.
...
4. Upload:
   ...
   `dist\Aetherglyph-Demo-1.11.0.aab`
...
6. Release name: `1.11.0 demo reaction overhaul`.
7. Suggested release notes:

   ```text
   <en-US>
   Updated environmental reactions, status interactions, control vulnerabilities,
   spell guides, and academy lessons for the offline demo.
   </en-US>
   ```
...
1. Increase `versionCode` above `11100`.
