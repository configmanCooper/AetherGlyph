...
This guide is tailored to the current Aetherglyph 1.12.0 Android releases.
...
| --- | --- | --- | --- | --- |
| Full game | Aetherglyph: Arcane Duels | `com.configmancooper.aetherglyph` | **$4.99 paid, one-time purchase** | `dist\Aetherglyph-1.12.0-release.aab` |
| Demo | Aetherglyph: Arcane Duels Demo | `com.configmancooper.aetherglyph.demo` | **Free** | `dist\Aetherglyph-Demo-1.12.0.aab` |
...
| App Bundle | `dist\Aetherglyph-1.12.0-release.aab` |
...
| Target audience | 13–15, 16–17, 18 and over |
| Version code | `11200` |
| Version name | `1.12.0-demo` |
| Minimum Android | Android 7.0 / API 24 |
| Target Android | API 36 |
| App Bundle | `dist\Aetherglyph-Demo-1.12.0.aab` |
...
3. Upload:
   ...
   `dist\Aetherglyph-1.12.0-release.aab`
...
5. Release name: `1.12.0 multiplayer lobby update`.
6. Suggested release notes:

   ```text
   <en-US>
   Private online rooms now open as ready-up lobbies with editable spell guides.
   Room codes and player seats remain available briefly through disconnects, and
   multiplayer rendering is more resilient across environmental effects.
   </en-US>
   ```
...
4. Add the already uploaded 1.12.0 bundle from the library.
...
4. Upload:
   ...
   `dist\Aetherglyph-Demo-1.12.0.aab`
...
6. Release name: `1.12.0 demo update`.
...
1. Increase `versionCode` above `11200`.
